function [W,b] = Linear_Compensation_Estimator(K,r0,T,A,B,Q,R,f,x0,sigma,mu2)
    ...
    for i = 1:M
       Ki = K + r(:,:,i);
       yi = GradientEstimator(Ki,r0,T,A,B,Q,R,f,x0) - Model_Gradient_Estimator(Ki,A,B,Q,R,sigma,mu2);
       Y(i,:) = reshape(yi, [1, np]);
    end
    y0 = GradientEstimator(Ki,r0,T,A,B,Q,R,f,x0);
