...
iters = 100;
r0 = 0.001;
a = 0.1; c2 = 0.1; % Factor of unknown nonliear function

rho = 0.3; Beta = 0.5;  % Factor of Line search

Gamma = 0.6; % Factor of Relative Error, \beta in Note 0905
...
%        keyboard
       ...
       [W,b] = Linear_Comp_Estimator_quad(x,r0,Q,a,c2);
