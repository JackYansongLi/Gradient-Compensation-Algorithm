function GC_LQR_Linear_Compensation
...
%        keyboard
       ...
       K_list_count(:,:, last_count + 1: total_count - 1 ) = reshape( repmat(K,1,total_count - last_count - 1),[p,n,total_count - last_count - 1]);
       K_list_count(:,:, total_count) = K_list(:,:,i+1);
       [W,b] = Linear_Compensation_Estimator(K,r,T,A,B,Q,R,f,x0,sigma,mu2);
...
% title('GC With Linear Compensation','Interpreter','latex','FontSize',16)
